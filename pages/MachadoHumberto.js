...
const MachadoHumbertoPage = () => (
  <>
    <Head>
      <title>Machado Humberto | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Machado Humberto | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={MachadoHumberto} alt="Foto de Machado Humberto" />
      </div>
