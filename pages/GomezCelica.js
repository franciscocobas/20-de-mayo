...
const GomezCelicaPage = () => (
  <>
    <Head>
      <title>Gomez Celica | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Gomez Celica | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={GomezCelica} alt="Foto de Gomez Celica" />
      </div>
