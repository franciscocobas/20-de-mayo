...
const BleierEduardoPage = () => (
  <>
    <Head>
      <title>Bleier Eduardo | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Bleier Eduardo | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={BleierEduardo} alt="Foto de Bleier Eduardo" />
      </div>
