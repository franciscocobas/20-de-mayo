...
const GonzalezLuisEduardoPage = () => (
  <>
    <Head>
      <title>Gonzalez Luis Eduardo | 27ᵃ marcha del silencio</title>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={GonzalezLuisEduardo} alt="Foto de Gonzalez Luis Eduardo" />
      </div>
      <div className={styles.downloadContainer}>
        ...
        <a href="https://www.gub.uy/secretaria-derechos-humanos-pasado-reciente/sites/secretaria-derechos-humanos-pasado-reciente/files/documentos/publicaciones/GONZALEZ%20GONZALEZ%2C%20Luis%20Eduardo%20Ficha%20accesible.pdf" target="_blank" rel="noopener noreferrer"><Image src={BioData} alt="Botón de ir a la página con más detalles" /></a>
      </div>
    </main>
  </>
);
