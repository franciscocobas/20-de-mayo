...
const TassinoOscarPage = () => (
  <>
    <Head>
      <title>Tassino Oscar | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Tassino Oscar | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    <Script
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={TassinoOscar} alt="Foto de Tassino Oscar" />
      </div>
