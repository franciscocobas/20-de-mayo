...
const GuazCarlosPage = () => (
  <>
    <Head>
      <title>Guaz Carlos | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Guaz Carlos | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    <Script
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={GuazCarlos} alt="Foto de Guaz Carlos" />
      </div>
