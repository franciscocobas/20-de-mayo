...
const CarreteroMadelRosarioPage = () => (
  <>
    <Head>
      <title>Carretero Ma del Rosario | 27ᵃ marcha del silencio</title>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={CarreteroMadelRosario} alt="Foto de Carretero Ma del Rosario" />
      </div>
