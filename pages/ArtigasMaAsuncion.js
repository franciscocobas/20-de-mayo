...
const ArtigasMaAsuncionPage = () => (
  <>
    <Head>
      <title>Artigas Ma Asuncion | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Artigas Ma Asuncion | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={ArtigasMaAsuncion} alt="Foto de Artigas Ma Asuncion" />
      </div>
