...
const HernandezHobbasBeatrizPage = () => (
  <>
    <Head>
      <title>Hernandez Hobbas Beatriz | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Hernandez Hobbas Beatriz | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={HernandezHobbasBeatriz} alt="Foto de Hernandez Hobbas Beatriz" />
      </div>
