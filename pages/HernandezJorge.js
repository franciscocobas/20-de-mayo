...
const HernandezJorgePage = () => (
  <>
    <Head>
      <title>Hernandez Jorge | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Hernandez Jorge | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={HernandezJorge} alt="Foto de Hernandez Jorge" />
      </div>
      <div className={styles.downloadContainer}>
        ...
        <a href="https://www.gub.uy/secretaria-derechos-humanos-pasado-reciente/sites/secretaria-derechos-humanos-pasado-reciente/files/documentos/publicaciones/HERNANDEZ%20RODRIGUEZ%2C%20Jorge%20Ficha%20accesible.pdf" target="_blank" rel="noopener noreferrer"><Image src={BioData} alt="Botón de ir a la página con más detalles" /></a>
      </div>
    </main>
  </>
);
