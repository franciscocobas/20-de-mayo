...
const BellizziAndresPage = () => (
  <>
    <Head>
      <title>Bellizzi Andres | 27ᵃ marcha del silencio</title>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={BellizziAndres} alt="Foto de Bellizzi Andres" />
      </div>
      <div className={styles.downloadContainer}>
        <Link href="/" scroll={false}>
          <a className={styles.downloadBtnWithText}><Image src={BackArrowWithText}  alt="Botón de volver atrás" /></a>
        </Link>
        <a href={BellizziAndres.src} download><Image src={DownloadIcon} alt="Icono de descargar la imagen" /></a>
        <a href="https://www.gub.uy/secretaria-derechos-humanos-pasado-reciente/sites/secretaria-derechos-humanos-pasado-reciente/files/documentos/publicaciones/BELLIZZI%20BELLIZZI%2C%20Andr%C3%A9s%20Humberto%20ficha%202018%20accesible.pdf" target="_blank" rel="noopener noreferrer"><Image src={BioData} alt="Botón de ir a la página con más detalles" /></a>
      </div>
    </main>
  </>
);

export default BellizziAndresPage;
