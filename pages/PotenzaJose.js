...
const PotenzaJosePage = () => (
  <>
    <Head>
      <title>Potenza Jose | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Potenza Jose | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={PotenzaJose} alt="Foto de Potenza Jose" />
      </div>
