...
const SobrinoGuillermoPage = () => (
  <>
    <Head>
      <title>Sobrino Guillermo | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Sobrino Guillermo | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={SobrinoGuillermo} alt="Foto de Sobrino Guillermo" />
      </div>
