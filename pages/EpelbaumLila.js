...
const EpelbaumLilaPage = () => (
  <>
    <Head>
      <title>Epelbaum Lila | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Epelbaum Lila | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    <Script
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={EpelbaumLila} alt="Foto de Epelbaum Lila" />
      </div>
      <div className={styles.downloadContainer}>
        <Link href="/" scroll={false}>
          <a className={styles.downloadBtnWithText}><Image src={BackArrowWithText}  alt="Botón de volver atrás" /></a>
        </Link>
        <a href={EpelbaumLila.src} download><Image src={DownloadIcon} alt="Icono de descargar la imagen" /></a>
        <a href="https://www.gub.uy/secretaria-derechos-humanos-pasado-reciente/sites/secretaria-derechos-humanos-pasado-reciente/files/documentos/publicaciones/EPELBAUM%20SLOTOPOLSKY%2C%20Lila%20Ficha%202018%20accesible.pdf" target="_blank" rel="noopener noreferrer"><Image src={BioData} alt="Botón de ir a la página con más detalles" /></a>
      </div>
    </main>
  </>
);
