...
const MoyanoAlfredoPage = () => (
  <>
    <Head>
      <title>Moyano Alfredo | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Moyano Alfredo | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    <Script
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={MoyanoAlfredo} alt="Foto de Moyano Alfredo" />
      </div>
