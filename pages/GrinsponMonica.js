...
const GrinsponMonicaPage = () => (
  <>
    <Head>
      <title>Grinspon Monica | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Grinspon Monica | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    <Script
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={GrinsponMonica} alt="Foto de Grinspon Monica" />
      </div>
