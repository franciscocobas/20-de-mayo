...
const EscuderoJulioPage = () => (
  <>
    <Head>
      <title>Escudero Julio | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Escudero Julio | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    <Script
...
export default EscuderoJulioPage;
