...
const PeluaMartinPage = () => (
  <>
    <Head>
      <title>Pelua Martin | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Pelua Martin | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={PeluaMartin} alt="Foto de Pelua Martin" />
      </div>
