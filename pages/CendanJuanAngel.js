...
const CendanJuanAngelPage = () => (
  <>
    <Head>
      <title>Cendan Juan Angel | 27ᵃ marcha del silencio</title>
      <meta name="description" content="Cendan Juan Angel | Accedé a los retratos de las y los desaparecidos para sostenerlos en la Marcha del Silencio."/>
    </Head>
    <Script
    ...
    <main className={styles.main}>
      <div className={styles.mainImageContainer}>
        <Image layout="fill" placeholder="blur" src={CendanJuanAngel} alt="Foto de Cendan Juan Angel" />
      </div>
